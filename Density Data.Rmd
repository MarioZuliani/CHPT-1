...
measure %>%
  ggplot(aes(measure, n)) + geom_col() + theme_classic() + xlab("Method of Measurement") + ylab("Count") + ggtitle("Methods of Measuring Shrub Denisty") + theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
